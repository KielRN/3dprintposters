...
Note: this is the earlier STL-only service scaffold. New architecture work should target `services/print-file-generator`, where STL is one artifact inside a broader print file bundle.
