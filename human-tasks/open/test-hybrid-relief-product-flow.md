...
Owner: Human
Created: 2026-05-11
Source: `AGENTS.md`, `AI_DEVELOPER_NOTES.md`, `apps/functions/src/index.ts`, `services/print-file-generator/app/models.py`
...
6. Confirm checkout unlocks only after the hybrid print-file artifacts are generated.
7. If the flow fails or the relief quality is not acceptable, capture the failure as the next AI developer fix target.
