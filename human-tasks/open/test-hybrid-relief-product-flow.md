...
6. Confirm the generated `preview.glb` is no longer neutral gray and uses image-derived color while the downloadable STL still represents a 5.5in x 7.5in physical object with a 5in x 7in image relief window and shaped 1/4in border/frame.
