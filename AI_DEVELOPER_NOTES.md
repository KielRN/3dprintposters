...
This file is kept as a compatibility pointer for older agent instructions.

Use these root sources instead:

- `DECISIONS.md` for durable product and architecture decisions.
